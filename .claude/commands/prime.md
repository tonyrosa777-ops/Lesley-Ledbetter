...
| people experiencing spiritual awakenings who feel confused or overwhelmed by emerging abilities | initial-business-data.md Section 3 — specific, not generic |
| 60-minute spiritual consult via Zoom ($100/session) | initial-business-data.md Section 2 |
| launch a live, Google-indexed website that generates bookings for spiritual consult sessions | initial-business-data.md Section 5 |
| Calendly (embedded widget, max 8 hrs/day) | initial-business-data.md Section 5 — or "TBD — confirm before Phase 4" |
...
19. Route structure — /service-areas/[city]:
    ...
    A. src/app/service-areas/page.tsx — index page
       ...
       - generateMetadata: title "Service Areas | Collaborative Insights"
    ...
    C. src/app/service-areas/[city]/page.tsx — individual city page (SERVER component)
       ...
       - generateMetadata({ params }): unique title + description per city
         title: "[Service] in [City], [State] | Collaborative Insights"
